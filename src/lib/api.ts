...
export const colaEstadosDocsApi = {
  ...
  inicializarPorEstado: (estado_origen: string, estado_destino: string, codigo_entidad?: string) =>
    api.post<{ encolados: number; omitidos: number; total: number }>('/cola-estados-docs/inicializar-por-estado', { estado_origen, estado_destino, codigo_entidad }).then((r) => r.data),
  cerrar: () =>
