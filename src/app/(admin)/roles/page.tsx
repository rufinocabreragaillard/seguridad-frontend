...
import { Languages, Pencil, Plus, RefreshCw, Search, Trash2, X } from 'lucide-react'
          ...
          <div className="flex border-b border-borde -mx-1 overflow-x-auto">
            {TABS_MODAL.map((tab) => (
              <button
                ...
                className={`flex-1 text-center px-3 py-2 whitespace-nowrap tab-nav${tabModal === tab.key ? ' tab-nav-activo' : ''}`}
              >
                {tab.label}
              </button>
            ))}
