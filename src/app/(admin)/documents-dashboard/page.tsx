...
export default function PaginaDocumentosDashboard() {
  ...
  // Accesos rápidos
  const accesos = [
    { nombre: t('irProcesarDocumentos'), href: '/process-documents', icono: Cpu },
    { nombre: t('irCargarDocumentos'), href: '/document-locations', icono: FolderTree },
    { nombre: t('irCategorias'), href: '/document-categories', icono: Tags },
  ]
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2.5">
                    {estadosValidos.map((e) => {
                      ...
                      const url = `/process-documents?estado=${encodeURIComponent(e.codigo_estado_doc)}`
                      return (
                        <div
